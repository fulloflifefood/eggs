...
Background:
  ...
  Given there is a member user with the following attributes:
    ...
    | Ben         | Brown     | benbrown@example.com  |
  ...
  Given the member "Brown" has a subscription for "EggShare Eggs"

  Given the member "Brown" has a "EggShare Eggs" transaction "credit" for "100"
  Given the member "Brown" has a "EggShare Eggs" transaction "debit" for "3"
  Given the member "Brown" has a "EggShare Eggs" transaction "debit" for "17"
